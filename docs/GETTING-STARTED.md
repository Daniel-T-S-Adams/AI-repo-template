...
> The normal workflow is intentionally short: create a repository from `Daniel-T-S-Adams/AI-repo-template`, point Claude Code or Codex at it, and let the first agent normalize the template before introducing the real project.
...
## If You Are Maintaining AI-repo-template Itself

Do not run downstream normalization against `Daniel-T-S-Adams/AI-repo-template`.
...
The resulting repository should stop looking like `AI-repo-template` and start looking like the actual project.
